#def A **Vector Space** is a nonempty set V of vectors, where vector addition & scalar multiplication is well defined and satisfy the following rules for any $u,v,w \space \in V$ and $c, d \space \in \mathbb{R}$
